...
const Register = () => {
  ...
  return (
    <div
      className={`max-h-screen overflow-x-clip md:block bg-bgcolor flex flex-col relative ${
        success ? "overflow-hidden" : "overflow-auto"
      }`}
    >
      {success ? <Confirmation setSuccess={onSetSuccess} /> : null}
      <div className="md:px-32 md:pl-32 pl-12 md:pt-14 py-8 md:pb-6 md:hidden flex z-10 font-[ClashDisplay] font-bold md:text-4xl text-2xl text-tertiary">
        Register
      </div>
      ...
      <div className="md:px-10 animate-slide flex md:flex-row flex-col lg:px-[5%] px-12 py-16 md:justify-between relative overflow-x-clip justify-center">
        ...
        <div className="basis-[55%] register-box relative  flex flex-col md:gap-8 gap-0 md:text-sm text-xs rounded-md lg:p-16 md:p-8 p-0 shadow-lg bg-gray-500 md:bg-opacity-10 bg-opacity-0 backdrop-blur-lg">
